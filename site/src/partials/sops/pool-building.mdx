...
Only after the user confirms the imported playlist and order should the pool be
treated as a locked **chapter** for live performance or further set planning.
