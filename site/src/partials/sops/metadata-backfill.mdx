...
After steps 1–2, tracks may still lack labels. The automated backfill checks four enrichment providers (Discogs, MusicBrainz, Bandcamp, Beatport). This step fills the rest using web research and model knowledge.
