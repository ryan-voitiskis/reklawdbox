...
when coverage is incomplete; classification will lower affected tracks to low
or insufficient confidence. Those tracks require individual review, never bulk
approval. Retry actual errors, but do not require a match for a legitimately
searched release.
