...
`write_xml` produces a Rekordbox-compatible XML file. In Rekordbox: **File > Import > rekordbox xml**, then select tracks to update. See [XML Export](/reference/xml-export/) for the full import workflow and known quirks.
