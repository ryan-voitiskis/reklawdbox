...
Interactive setup wizard. Writes a config file at `~/Library/Application Support/reklawdbox/config.toml` with broker URL and token settings.
...
Only needed if you are self-hosting a Discogs broker. The default broker is preconfigured.
