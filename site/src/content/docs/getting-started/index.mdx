...
To make reklawdbox available in additional directories, copy or create `.mcp.json` there:
...
If you built from source, use the full absolute path to the binary (e.g., `/Users/you/reklawdbox/target/release/reklawdbox`). Relative paths resolve from the directory containing `.mcp.json`, not the repo.
...
<Tabs>
  <TabItem label="Claude Code">
    ...
    Then start Claude Code from `~/Music`:
  ...
  <TabItem label="Claude Desktop">
    ...
    If you built from source, use the full absolute path to the binary (e.g., `/Users/you/reklawdbox/target/release/reklawdbox`). Relative paths resolve from the config file's directory, not the repo.
  </TabItem>
  <TabItem label="Codex">
    ```bash
