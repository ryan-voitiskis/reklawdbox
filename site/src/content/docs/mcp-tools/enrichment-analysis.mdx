...
|-------|------|:--------:|-------------|
| `summary` | object | **yes** | Counts for the selected work page |
...
| `next_offset` | integer | **yes** | Underlying index after the last examined candidate when more remain; `null` at the end |
...
| Field | Type | Required | Description |
|-------|------|:--------:|-------------|
| `summary` | object | **yes** | Counts for the selected analysis page |
