...
{/* doc-contract:mcp tool=score_transition schema=/ requiredness=global */}
...
| `priority` | string \| object | | | Transition weight spec (see [below](#transition-weight-spec)) |
...
{/* doc-contract:mcp tool=query_transition_candidates schema=/ requiredness=global */}
...
{/* doc-contract:mcp tool=build_set schema=/ requiredness=global */}
...
{/* doc-contract:mcp tool=score_pool_compatibility schema=/ requiredness=conditional */}
...
| `preset` | string \| object | `"balanced"` | Pool weight spec (see [below](#pool-weight-spec)) |
...
{/* doc-contract:mcp tool=expand_pool schema=/ requiredness=global include=shared-search-filters */}
...
| `preset` | string \| object | | Pool weight spec (see [below](#pool-weight-spec)) |
...
{/* doc-contract:mcp tool=describe_pool schema=/ requiredness=global */}
...
{/* doc-contract:mcp tool=discover_pools schema=/ requiredness=global include=shared-search-filters */}
...
Also accepts all [search filter parameters](/mcp-tools/#shared-search-filters) for scoping the input tracks.
...
{/* doc-contract:mcp tool=save_weight_preset schema=/ requiredness=global */}
...
{/* doc-contract:mcp tool=list_weight_presets schema=/ requiredness=global */}
...
{/* doc-contract:mcp tool=delete_weight_preset schema=/ requiredness=global */}
