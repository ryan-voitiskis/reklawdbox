...
pub(in crate::mcp) struct BatchPage {
    pub(in crate::mcp) matched_tracks: usize,
    pub(in crate::mcp) start_offset: usize,
    pub(in crate::mcp) examined_tracks: usize,
    pub(in crate::mcp) selected_tracks: usize,
    pub(in crate::mcp) fully_cached_skipped: usize,
    #[schemars(required, schema_with = "required_nullable_offset_schema")]
    pub(in crate::mcp) next_offset: Option<usize>,
    pub(in crate::mcp) has_more: bool,
}

#[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, schemars::JsonSchema)]
pub(in crate::mcp) struct OffsetPage {
    pub(in crate::mcp) total: usize,
    pub(in crate::mcp) returned: usize,
    pub(in crate::mcp) offset: usize,
    #[schemars(required, schema_with = "required_nullable_offset_schema")]
    pub(in crate::mcp) next_offset: Option<usize>,
    pub(in crate::mcp) has_more: bool,
}

pub(in crate::mcp) fn offset_page_bounds(
    total: usize,
    offset: usize,
    page_size: usize,
...
#[derive(Debug)]
pub(in crate::mcp) struct PendingBatchSelection<T> {
    pub(in crate::mcp) selected: Vec<T>,
    pub(in crate::mcp) page: BatchPage,
}
...
#[cfg(test)]
pub(in crate::mcp) fn pending_batch_page<T: Clone>(
    ordered: &[T],
    offset: u32,
    max_items: u32,
...
pub(in crate::mcp) fn resolve_pending_tracks(
    conn: &Connection,
    track_ids: Option<&[String]>,
    playlist_id: Option<&str>,
...
pub(in crate::mcp) fn resolve_tracks(
    conn: &Connection,
    track_ids: Option<&[String]>,
    playlist_id: Option<&str>,
    mut filters: SearchFilterParams,
...
pub(in crate::mcp) fn describe_resolve_scope(
    filters: &SearchFilterParams,
    track_ids: Option<&[String]>,
    playlist_id: Option<&str>,
...
pub(in crate::mcp) fn to_percent(count: usize, total: usize) -> f64 {
    if total == 0 {
        0.0
    } else {
