...
use super::scoring;
use super::weights as weight_resolve;
use crate::mcp::{
    DeleteWeightPresetParams, ListWeightPresetsParams, PoolPreset, PoolWeightInput,
    ReklawdboxServer, SaveWeightPresetParams, ScorerType, SequencingPriority,
    TransitionWeightInput, mcp_internal_error, ok_json,
};

pub(in crate::mcp) fn handle_save_weight_preset(
...
pub(in crate::mcp) fn handle_list_weight_presets(
    server: &ReklawdboxServer,
...
pub(in crate::mcp) fn handle_delete_weight_preset(
    server: &ReklawdboxServer,
