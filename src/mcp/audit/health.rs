...
use crate::mcp::enrichment::{OffsetPage, offset_page_bounds};
use crate::mcp::error::{db_error, mcp_internal_error, ok_json, ok_structured_json};
use crate::mcp::server::ReklawdboxServer;

pub(in crate::mcp) fn handle_scan_playlist_coverage(
...
pub(in crate::mcp) async fn handle_scan_broken_links(
...
pub(in crate::mcp) async fn handle_scan_orphan_files(
    server: &ReklawdboxServer,
...
pub(in crate::mcp) async fn handle_scan_duplicates(
    server: &ReklawdboxServer,
...
pub(in crate::mcp) struct ScanDuplicatesOutput {
